    ...
    class Asterisk
      ...
      def run_at_fully_booted
        if redirect_context_status =~ /failed/
          ...
          send_ami_action 'Command', 'Command' => "dialplan add extension #{AMD_EXTENSION},2,Goto(#{REDIRECT_CONTEXT},#{REDIRECT_EXTENSION},4) into #{AMD_CONTEXT}"
